    ...
    <div className={'relative m-auto h-full w-full'}>
        <main className='m-auto flex flex-col place-items-center bg-black'>
            <div className="h-full w-[100%] relative lg:w-[1024px] py-5">
                <Slider/>
                <div className="z-40 absolute bottom-0 px-4 py-3 w-full h-full space-y-20 place-items-center md:place-items-start justify-center flex flex-col lg:w-[1024px]">
                    <span className="text-white font-bold text-4xl mx-2.5 my-2.5"> Новый альбом/тур 2024</span>
                    <div className={'flex flex-col space-y-5 space-x-0 place-items-center w-full md:w-1/2 md:flex-row justify-center h-fit md:space-y-0 md:space-x-5'}>
                        <Link
                            ...
                            href={'#album'}
                            className={
                                ' text-xl bg-gray-500/50 w-2/3 flex flex-row place-items-center justify-around border-2 border-white py-3 px-5 uppercase text-white hover:bg-white hover:text-black md:w-full '
                            }
                        >
                            Послушать
                        </Link>
