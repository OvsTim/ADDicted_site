  ...
  const concerts:ConcertData[] = [
    {
      ...
      ticketsLink:'https://izhevsk.qtickets.events/96508-addicted-5-letie-gruppy-23-marta',
    },
    {
      date:'30 марта (сб)',
      city:'Воронеж',
      ...
      ticketsLink:'https://voronezh.qtickets.events/97618-addicted-5-let-sto-ruchev',
    }
      ...
      {concerts.map(concert =>
          ...
          >
            <Image
                ...
                alt={'concert'}
            />
            <div className={'m-2.5 flex  flex-col space-y-5 w-1/2 md:w-1/4'}>
