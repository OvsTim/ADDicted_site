...
const Contacts = () => {
    ...
    return (
        <div className={'w-full justify-center flex flex-col place-items-center'}>
            ...
            <div className={'flex flex-row bg w-1/3 h-fit justify-evenly mt-10 mb-5'}>
                <a
            ...
            <span className={'text-white text-2xl uppercase font-semibold'}>По вопросам организации концертов:</span>
